...
$uploadedBytes = ($data['uploaded_chunk_size'] ?? 0)
               + ($data['uploaded_file_chunk_size'] ?? 0)
               + ($data['uploaded_metadata_chunk_size'] ?? 0);
